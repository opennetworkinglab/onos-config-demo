...
class config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['components', 'component', 'port', 'breakout-mode', 'config']

...
class event(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__event_type = YANGDynClass(base=ReferenceType(referenced_path='../config/event-type', caller=self._path() + ['event-type'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="event-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='leafref', is_config=True)

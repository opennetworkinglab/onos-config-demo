...
class user(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__username = YANGDynClass(base=ReferenceType(referenced_path='../config/username', caller=self._path() + ['username'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="username", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='leafref', is_config=True)

...
class selector(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__facility = YANGDynClass(base=ReferenceType(referenced_path='../config/facility', caller=self._path() + ['facility'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="facility", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='leafref', is_config=True)
    self.__severity = YANGDynClass(base=ReferenceType(referenced_path='../config/severity', caller=self._path() + ['severity'], path_helper=self._path_helper, require_instance=True), is_leaf=True, yang_name="severity", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='leafref', is_config=True)

...
class state(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/grpc-server/state. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__certificate_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="certificate-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='string', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'grpc-server', 'state']

  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /system/grpc_server/state/enable (boolean)
...
default
  ...
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /system/grpc_server/state/enable (boolean)
...
default
  ...
  def _get_port(self):
    """
    Getter method for port, mapped from YANG variable /system/grpc_server/state/port (oc-inet:port-number)
  ...
  def _set_port(self, v, load=False):
    """
    Setter method for port, mapped from YANG variable /system/grpc_server/state/port (oc-inet:port-number)
    If this variable is read-only (config: false) in the
  ...
  def _get_transport_security(self):
    """
    Getter method for transport_security, mapped from YANG variable /system/grpc_server/state/transport_security (boolean)
  ...
  def _set_transport_security(self, v, load=False):
    """
    Setter method for transport_security, mapped from YANG variable /system/grpc_server/state/transport_security (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_certificate_id(self):
    """
    Getter method for certificate_id, mapped from YANG variable /system/grpc_server/state/certificate_id (string)
  ...
  def _set_certificate_id(self, v, load=False):
    """
    Setter method for certificate_id, mapped from YANG variable /system/grpc_server/state/certificate_id (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="certificate-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """certificate_id must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="certificate-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='string', is_config=False)""",
        })
  ...
  def _get_listen_addresses(self):
    """
    Getter method for listen_addresses, mapped from YANG variable /system/grpc_server/state/listen_addresses (union)
...
on. This may be an IPv4 or an IPv6 address
  ...
  def _set_listen_addresses(self, v, load=False):
    """
    Setter method for listen_addresses, mapped from YANG variable /system/grpc_server/state/listen_addresses (union)
    If this variable is read-only (config: false) in the

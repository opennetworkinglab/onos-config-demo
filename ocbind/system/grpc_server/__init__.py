...
class grpc_server(PybindBase):
  ...
  from YANG module openconfig-system - based on the path /system/grpc-server. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['system', 'grpc-server']

  def _get_config(self):
    """
    Getter method for config, mapped from YANG variable /system/grpc_server/config (container)
  ...
  def _set_config(self, v, load=False):
    """
    Setter method for config, mapped from YANG variable /system/grpc_server/config (container)
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /system/grpc_server/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /system/grpc_server/state (container)
    If this variable is read-only (config: false) in the
